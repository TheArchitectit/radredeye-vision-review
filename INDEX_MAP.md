...
| project-status | STATUS.md | ./ | **Current project phase, blockers, what's done/next** ⭐ |
| sprint-roadmap | ROADMAP.md | ./ | **Phased sprint plan with deliverables and exit criteria** ⭐ |
| agents-guide | AGENTS.md | ./ | **Agent onboarding: commands, architecture, patterns, gotchas** ⭐ |
| architecture | ARCHITECTURE.md | docs/radredeye/ | radredeye layer diagram, core concepts |
| support-matrix | SUPPORT_MATRIX.md | docs/radredeye/ | Engine/sink implementation status |
...
|----------|-------------------|-------------|
| **AGENTS.md** | Agent onboarding: commands, architecture, patterns, gotchas | First read for any new agent |
| **ROADMAP.md** | Phased sprint plan with deliverables and exit criteria | Planning sprints, tracking progress |
| **STATUS.md** | Current phase, blockers, what's done/next | Quick status check |
