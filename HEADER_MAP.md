...
| 35 | ## Feature Flags |
| 43 | ## Known Build Issue |
| 45 | ## Environment Variables |
| 49 | ## Code Patterns & Conventions |
| 59 | ## Godot Addon |
| 64 | ## Repo Quirks |
| 70 | ## Project Status |
| 73 | ## Adding a New Sink |
| 79 | ## Adding a New Engine Adapter |
...
| Line | Header |
|------|--------|
| 1 | # radredeye — Sprint Roadmap |
| 7 | ## How This Doc Works |
| 17 | ## Phase 0 — Foundation |
| 24 | ## Phase 1 — Core Sinks & Daemon Bridge |
| 35 | ## Phase 2 — Testing & CI |
| 48 | ## Phase 3 — Additional Sinks |
| 62 | ## Phase 4 — Engine Adapters |
| 76 | ## Phase 5 — Production Hardening |
| 90 | ## Phase 6 — Docs & Release |
| 104 | ## Quick Reference: Sprint Priorities |
